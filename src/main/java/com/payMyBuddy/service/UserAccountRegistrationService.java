...
public class UserAccountRegistrationService {
	...
	public UserAccountInformations attributeAccountInformations(SignUpRequest userPersonnalInformations_dto) {
		UserAccountInformations userAccountInformations = new UserAccountInformations();
		userAccountInformations.setSold_account(0);
		String account_reference_transaction = "pmb" + userPersonnalInformations_dto.getEmail().substring(0, 1) + userPersonnalInformations_dto.getEmail().substring(2, 5) + userPersonnalInformations_dto.getUserID() + "b";
